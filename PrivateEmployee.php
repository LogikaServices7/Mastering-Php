...
echo $emp1->getName(). " has worked for ". $emp1->getWorkingDays() ." days and has taken " . $emp1->getTotalLeaveTaken(). " leaves." . PHP_EOL;
echo $emp1->getName(). " salary is $salary" . PHP_EOL;

$emp2 = new Employee(102, "Jacob", 2);
$salary = $emp2->getSalaryAmount(20);
echo $emp2->getName(). " has worked for " .$emp2->getWorkingDays(). " days and has taken ". $emp2->getTotalLeaveTaken(). " leaves." . PHP_EOL;
